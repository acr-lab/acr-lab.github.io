...
{% assign role_names = "Scientific Advisory Board|Directors|Core Members|Postdoctoral Fellows|PhD Students|Masters Students|Undergraduate Researchers" | split: "|" %}

{% for role in roles %}
  {% assign members = "" | split: "" %}
  {% for person in site.people %}
    {% if person.role == role or person.role contains role %}
      {% assign members = members | push: person %}
    {% endif %}
  {% endfor %}
  {% assign members = members | sort: "order" %}
  {% if members.size > 0 %}
